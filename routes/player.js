...
export default function (app, ctx) {
  ...
  app.get("/play", (c) => {
    ...
    const html = getInlinePlayerHTML(displayName, audioSrc, translate, false);
    return c.html(html);
    return c.html(html);
  });
...
function getInlinePlayerHTML(displayName, audioSrc, translate, isOnline) {

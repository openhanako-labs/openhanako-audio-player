...
const description = "播放**已存在的本地音频文件**，通过对话内嵌卡片播放（仅播放，不做 TTS 合成）。filePath 必须是本机真实存在的音频文件绝对路径（wav/mp3/ogg 等），且文件需真实存在；禁止传歌名/随机等描述。若需要语音合成请用 tts/tts_bus 工具，不要用本工具。";
